...
class esolModel(torch.nn.Module):
    def __init__(self, n_features, embedding_size):
        super(esolModel,self).__init__()
        ...
        self.conv3 = GATv2Conv(embedding_size, embedding_size, heads=4, concat=False, dropout=0.2)
        self.lin2 = torch.nn.Linear(embedding_size*4, embedding_size)
